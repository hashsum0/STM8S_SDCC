...
#define SPI_CR1_LSBFIRST (1 << 7) // if 0 then 01234567 else 76543210
#define SPI_CR1_SPE (1 << 6) //enable spi
#define SPI_CR1_BR0 (1 << 3) //000: fMASTER/2  001: fMASTER/4 
#define SPI_CR1_BR1 (1 << 4) //010: fMASTER/8  011: fMASTER/16 110: fMASTER/128
#define SPI_CR1_BR2 (1 << 5) //100: fMASTER/32 101: fMASTER/64 111: fMASTER/256
#define SPI_CR1_MSTR (1 << 2) //master/slave
#define SPI_CR1_CPOL (1 << 1) // hight or low when idle
#define SPI_CR1_CPHA (1 << 0) // octive front
