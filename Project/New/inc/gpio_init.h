void GPIO_init(void)
{
  ...
  PB_DDR = 0x00;                                                        //_______0__________________0________________1_____________bez podtiyzhki,c prerbIvaniem 
   PB_CR1 = 0xff;                                                       //_______0__________________1________________1_____________c podtiyzhki,c prerbIvanii
  ...
  PC_DDR = 0x00;                                                        //_______1__________________0________________0_____________otkritiy stok
   PC_CR1 = 0xFF;                                                       //_______1__________________1________________0_____________dvuhtakthiy vihod
    PC_CR2 = 0xFF;                                                      //_______1__________________X________________1_____________skorost' do 10MHz
