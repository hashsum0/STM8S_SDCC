...
void delay(int sec)
{
 ...
 /*******************************************/
INTERRUPT_HANDLER( TIM2_OVR_UIF, 13)           //обработчик прерывания по переполнению таймера 
{
 ...
 /*******************************************/
INTERRUPT_HANDLER( EXTI_PORTC_IRQHandler, 5) //обработчик прерывания датчика перехода нуля
{ 
    //UPR_PIN_OFF;
    TIM2_ARRH=i;           
    TIM2_ARRL=0x00; 
